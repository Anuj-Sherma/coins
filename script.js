		...
		.then((data) => {
			...
			for (let i = 0; i < 20; i++) {
                ...
                <button type="button" class="btn btn-success" id="buyBtnlow${i}"
                 onclick="buyDataShow('${data[i].symbol}','${data[i].name}','${n}')"><a href="#buyBox" style="
				 list-style: none;
...
let IPortfolio = 0;
	...
	<th class="text-center">Total <br> Coins </th>
...
<tbody  style="background-color: black;  color: ${p35}; border-color: black;">

	<tr  >
	<th id="holding"> ${HoldingNum} <br></th>
...
function increaseBalance(){
	swal({
		title: "Do UPI worth of 10 Rs to this ID :- ",
		text: `8805505788@ybl`,
		icon: "info",
		button: "OK!",
	  });
